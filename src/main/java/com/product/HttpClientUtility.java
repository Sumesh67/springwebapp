...
public class HttpClientUtility {
	...
	public static String getProductResponse(String query) throws Exception {

		CloseableHttpClient client = HttpClients.createDefault();
	    HttpPost httpPost = new HttpPost("https://api-qa.jaegar.io/catalog/search/products");
	 
	    String json = "{\"query\":\"" + query+ "\",\"suggest\":\"true\"}";
...
*/	    
	    ...
	    int count =0; 
	    StringBuffer topThreeItems = new StringBuffer();
	    while(count <3){
	    	JsonNode item = elements.next();
	    	Item newJsonNode = objectMapper.treeToValue(item, Item.class);
	    	topThreeItems.append(newJsonNode.getName());
	    	topThreeItems.append(",");
